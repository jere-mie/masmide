...
export const Header: React.FC<HeaderProps> = ({ onRun, onStop, onReset, isRunning }) => {
  return (
      ...
      <div className="flex items-center gap-1.5">
        {isRunning ? (
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded text-sm font-medium font-mono bg-[#89b4fa] text-[#1e1e2e] hover:bg-[#74c7ec] transition-colors cursor-pointer"
          >
